...
(function() {
  var AnnotateEnv, Builder, Code, Node, Transformer, Typenames, Types, UnsupportedError, VarEnv, blockTrim, buildCoffee, exports, indentLines, isSingleLine, ltrim, narrowJson, p, paren, parser, pkg, rtrim, strEscape, strEscapeDoubleQuotes, strEscapeSingleQuotes, strRepeat, trim, truthy, unreserve, unshift, _, _ref, _ref1,
  ...
  Builder = (function() {
    ...
    Builder.prototype['script'] = function(n, opts) {
      var c, cc, ea, overridden, vv, _i, _len, _ref2, _ref3;
      if (opts == null) {
        opts = {};
      }
      c = new Code;
      if (n.functionBody) {
        if ((ea = n.envAnnotation) != null) {
          _ref2 = ea.newVars();
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            vv = _ref2[_i];
            c.add("" + vv + " = undefined\n");
      ...
      if (n.functionBody) {
        if ((ea = n.envAnnotation) != null) {
          if ((_ref3 = (overridden = ea.overriddenVars())) != null ? _ref3.length : void 0) {
            cc = new Code;
    ...
    Builder.prototype['regexp'] = function(n) {
      var flags, m, value, _ref2;
      m = n.value.toString().match(/^\/(.*)\/([a-z]*)$/);
      value = m[1];
      flags = m[2];
      if ((_ref2 = value[0]) === ' ' || _ref2 === '=') {
        value = "\\" + value;
      }
      value = value.replace(/(^|[^\\])([\"\'])/g, function(x, a, b) {
        return a + "\\" + b;
      });
      return this.l(n) + ("/" + value + "/" + flags);
    };
    ...
    Builder.prototype['if'] = function(n) {
      ...
      if (n.thenPart.isA('block') && n.thenPart.children.length === 0 && (n.elsePart == null)) {
        c.add("" + keyword + " " + (this.build(n.condition)) + " then\n");
  ...
  Transformer = (function() {
    ...
    Transformer.prototype['if'] = function(n) {
      if (n.thenPart.isA('block') && n.thenPart.children.length === 0 && (n.elsePart != null) && (!n.elsePart.isA('block') || n.elsePart.children.length > 0)) {
        n.positive = false;
  ...
  VarEnv = (function() {
    function VarEnv(vars, parent) {
      this.vars = vars != null ? vars : {};
      this.parent = parent != null ? parent : null;
      if (parent != null) {
        this.vars.__proto__ = parent.vars;
      }
    }

    VarEnv.prototype.has = function(v) {
      return this.vars[v] != null;
    };

    VarEnv.prototype.parentHas = function(v) {
      var _ref2;
      return (_ref2 = this.parent) != null ? _ref2.has(v) : void 0;
    };

    VarEnv.prototype.add = function(v) {
      return this.vars[v] = 'var';
    };

    VarEnv.prototype.currentVars = function() {
      var k, r, _i, _len, _ref2;
      r = [];
      _ref2 = Object.keys(this.vars);
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        k = _ref2[_i];
        if (this.vars[k] === 'var') {
          r.push(k);
    ...
    VarEnv.prototype.newVars = function() {
      var r, v, _i, _len, _ref2;
      r = [];
      _ref2 = this.currentVars();
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        v = _ref2[_i];
        if (!this.parentHas(v)) {
          r.push(v);
    ...
    VarEnv.prototype.overriddenVars = function() {
      var r, v, _i, _len, _ref2;
      r = [];
      _ref2 = this.currentVars();
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
    ...
    VarEnv.prototype.extend = function(vars) {
      return new VarEnv(vars, this);
    };
  ...
  narrowJson = function(level, x) {
    var k, r, v, _i, _len;
    level--;
    try {
      if ('object' === typeof x) {
        if ((x != null ? x.constructor : void 0) === Node) {
          if (level < 0) {
            return "{node}";
          }
          r = {};
  ...
  AnnotateEnv = {
    transform: function(node, env) {
      var fn, type;
      if (env == null) {
        env = new VarEnv;
      }
      if (node.envAnnotation != null) {
        return;
      }
      type = node.typeName();
      fn = this[type];
      if (fn) {
        ...
        return this.defaultTransform(node, env);
      }
    },
    ';': function(n, e) {
      return this.defaultTransform(n.expression, e);
    },
    'if': function(n, e) {
      var _i, _len, _ref2, _results;
      _ref2 = [n.condition, n.thenPart, n.elsePart];
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        p = _ref2[_i];
        _results.push(this.defaultTransform(p, e));
      }
      return _results;
    },
    'try': function(n, e) {
      var _i, _j, _len, _len1, _ref2, _ref3, _results;
      _ref2 = n.catchClauses;
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        p = _ref2[_i];
        this["catch"](p, e);
      }
      _ref3 = [n.tryBlock].concat(n.catchClauses).concat([n.finallyBlock]);
      _results = [];
    ...
    'function': function(n, e) {
      ...
      this.defaultTransform(n.body, e.extend(r));
      return n.body.functionBody = 1;
    },
    'var': function(n, e) {
      var nn, r, _i, _len, _ref2, _results;
      r = {};
      _ref2 = n.children;
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        nn = _ref2[_i];
        _results.push(e.add(nn.name));
      }
      return _results;
    },
    defaultTransform: function(n, env) {
      var nn, _i, _len, _ref2;
      if (n == null) {
        return;
      }
      if (n.children != null) {
